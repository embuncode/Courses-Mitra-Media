  	  	...
  	  	<div class="col-md-12">
  	    	<div class="box box-success">
        		...
        		<div class="box-body table-responsive">
        		  	<table id='alumni-table' class="table table-bordered table-list">
        ...
        <div class="modal-content">
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Enter alamat" value="{{  old('alamat') }}" required>
                </div>

                <div class="form-group">
                    <label for="testimoni">Testimoni</label>
                    <textarea type="text" class="form-control" id="testimoni" name="testimoni" placeholder="Enter testimoni" value="{{  old('testimoni') }}" required></textarea>
                </div>
