      ...
      <div class="col-md-12">
        <div class="box box-success">
          <div class="box-header with-border">
            <h3 class="box-title">Data Paket 2</h3>
          ...
          <div class="box-body table-responsive">
            <table id='paket2-table' class="table table-bordered table-list">
...
<script type="text/javascript">
    ...
    var table = $('#paket2-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: 'paket2/apiPaket2',
        columns: [
    ...
    $(function() {
        $('#modal-form form').on('submit', function (e) {
            if (!e.isDefaultPrevented()) {
                var id = $('#id').val();
                if (save_method == 'add') url = "{{ url ('/paket2') }}";
                else url = "{{ url('paket2') . '/' }}" + id;
